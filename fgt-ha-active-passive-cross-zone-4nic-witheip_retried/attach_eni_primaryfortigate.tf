...
resource "alicloud_network_interface_attachment" "PrimaryFortigateattachment1" {
 depends_on = [alicloud_network_interface.PrimaryFortiGateInterface1,alicloud_network_interface.PrimaryFortiGateInterface3,alicloud_instance.PrimaryFortigate]

...
// depends_on =[alicloud_cen_transit_router.default,alicloud_vpc.ack2_vpc_default,time_sleep.wait_600_seconds,alicloud_cen_transit_router_vpc_attachment.atta_ack1]

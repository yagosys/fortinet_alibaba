...
//  default = "m-t4n4r83t65xn4y88rbk4" //7.0.1 PAGO international 
 //  default = "m-uf6cir5blv91vxt767p6" //6.4.5 BYOL China huadong2
    default = "m-2zec5gpamoc7qaxzrx8x" //6.4.5 BYOL china beijing 
...
variable "instance" {
  ...
  default = "ecs.hfc6.2xlarge" //this support 3ENI and ENI hot-plug
}
